...
for i in range(25):
    ...
    make_Mo_Ca2N_var_z('STRUCT', xd = (i/24)*q[0], yd = (i/24)*q[1]) 
    os.system('cat PARAMS STRUCT KPTS >> relax.in')
    os.system('dos2unix relax.in')
    os.system('mv relax.in  ' + iteration)

    make_bash_graham('relax.sh', qe_inputfile = 'relax.in', qe_outputfile = 'relax.out',  memory=125, nodes=3, job_name = 'Mo_Ca2N_rlx_L_' + iteration, time = '1-00:00:00')
